<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityCharts.aspx.cs" Inherits="Industrial_Project.webfroms.ActivityCharts" %>
                    ...
                    if (window.myChart.config.type === "pie") {
                        ...
                        if (listBox === "None") {
                            ...
                            $.when(
                                jQuery.ajax({
                                    //async: false,
                                    url: "ActivityCharts.aspx/GetBarPieColumnData",
                            ...
                            jQuery.ajax({
                                //async: false,
                                url: "ActivityCharts.aspx/GetBarPieGraphData",
                                data: JSON.stringify(obj),
                                dataType: "json",
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $(".locationChange").change(function () {
                    ...
                    if (window.myChart.config.type === "line") {
                        ...
                        if (locations[0] !== "None selected") {
                            ...
                            for (i = 0; i < locations.length - 1; i++) {
                                ...
                                (function (i) {
                                    jQuery.ajax({
                                        async: false,
                                        url: "ActivityCharts.aspx/GetColumnData",
                                    ...
                                    jQuery.ajax({
                                        async: false,
                                        url: "ActivityCharts.aspx/initializeChart",
                                        data: JSON.stringify(obj),
                                        dataType: "json",
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                        ...
                        jQuery.ajax({
                            //async: false,
                            url: "ActivityCharts.aspx/GetBarPieDateRangeColumn",
                            data: JSON.stringify(obj),
                            dataType: "json",
                            type: "POST",
                            contentType: " application/json; charset=utf-8",
                        ...
                        jQuery.ajax({
                            //async: false,
                            url: "ActivityCharts.aspx/GetBarPieDateRangeData",
                            data: JSON.stringify(obj),
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
