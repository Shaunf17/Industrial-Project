<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalSalesCharts.aspx.cs" Inherits="Industrial_Project.webfroms.TotalSalesCharts" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid chartContainer" style="z-index: -1;margin-left:10%;">
            <div class="row">
                <h1 class="col-md-4 col-md-offset-5">Total Sales</h1>
             </div>
            <div class="row">
                    ...
                    if (window.myChart.config.type === "pie") {
                        ...
                        if (listBox === "None") {
                            ...
                            $.when(
                                jQuery.ajax({
                                    //async: false,
                                    url: "TotalSalesCharts.aspx/GetBarPieColumnData",
                            ...
                            jQuery.ajax({
                                //async: false,
                                url: "TotalSalesCharts.aspx/GetBarPieGraphData",
                                data: JSON.stringify(obj),
                                dataType: "json",
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
            ...
            $(document).ready(function () {
                $(".locationChange").change(function () {
                    ...
                    if (window.myChart.config.type === "line") {
                        ...
                        if (locations[0] !== "None selected") {
                            ...
                            for (i = 0; i < locations.length - 1; i++) {
                                ...
                                (function (i) {
                                    jQuery.ajax({
                                        async: false,
                                        url: "TotalSalesCharts.aspx/GetColumnData",
                                    ...
                                    jQuery.ajax({
                                        async: false,
                                        url: "TotalSalesCharts.aspx/initializeChart",
                                        data: JSON.stringify(obj),
                                        dataType: "json",
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                        ...
                        jQuery.ajax({
                            //async: false,
                            url: "TotalSalesCharts.aspx/GetBarPieDateRangeColumn",
                            data: JSON.stringify(obj),
                            dataType: "json",
                            type: "POST",
                            contentType: " application/json; charset=utf-8",
                        ...
                        jQuery.ajax({
                            //async: false,
                            url: "TotalSalesCharts.aspx/GetBarPieDateRangeData",
                            data: JSON.stringify(obj),
                            dataType: "json",
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
